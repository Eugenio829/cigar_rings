...
# Configuración para la base de datos MySQL de PythonAnywhere
# Reemplaza los valores con los que encontrarás en la pestaña 'Databases' de PythonAnywhere
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'tu-usuario$tu-basededatos',
        'USER': 'tu-usuario',
