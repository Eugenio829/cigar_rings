...
# Render detecta el entorno de producción y ajusta DEBUG automáticamente.
...
# Render agrega automáticamente el nombre de host de la aplicación a ALLOWED_HOSTS.
...
MIDDLEWARE = [
    ...
    'apps.core.middleware.LoginRequiredMiddleware', # Middleware para login obligatorio
]
...
# Configuración de la base de datos para Render (PostgreSQL) y local (SQLite)
DATABASES = {
...
# Almacenamiento de archivos estáticos para Whitenoise
STORAGES = {
    "staticfiles": {
